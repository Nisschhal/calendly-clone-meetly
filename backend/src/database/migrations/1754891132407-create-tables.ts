...
export class CreateTables1754891132407 implements MigrationInterface {
    name = 'CreateTables1754891132407'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."integration_provider_enum" AS ENUM('GOOGLE', 'ZOOM', 'MICROSOFT')`);
        await queryRunner.query(`CREATE TYPE "public"."integration_category_enum" AS ENUM('CALENDAR_AND_VIDEO_CONFERENCING', 'VIDEO_CONFERENCING', 'CALENDAR')`);
        await queryRunner.query(`CREATE TYPE "public"."integration_app_type_enum" AS ENUM('GOOGLE_MEET_AND_CALENDAR', 'ZOOM_MEETING', 'OUTLOOK_CALENDAR')`);
