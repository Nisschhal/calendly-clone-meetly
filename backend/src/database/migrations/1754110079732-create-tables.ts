...
export class CreateTables1754110079732 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."integration_provider_enum" AS ENUM('GOOGLE', 'ZOOM')`);
        await queryRunner.query(`CREATE TYPE "public"."integration_category_enum" AS ENUM('CALENDER_AND_VIDEO_CONFERENCE', 'VIDEO_CONFERENCE', 'CALENDER')`);
        await queryRunner.query(`CREATE TYPE "public"."integration_app_type_enum" AS ENUM('GOOGLE_MEET_AND_CALENDER', 'ZOOM_MEETING', 'OUTLOOK_CALENDAR')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."meetings_status_enum" AS ENUM('SCHEDULE', 'CANCELLED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."events_locationtype_enum" AS ENUM('GOOGLE_MEET_AND_CALENDER', 'ZOOM_MEETING')`);
